...
[![PyPI](https://img.shields.io/pypi/v/cognis-jwtinspect.svg)](https://pypi.org/project/cognis-jwtinspect/)
[![CI](https://github.com/cognis-digital/jwtinspect/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/jwtinspect/actions)
...
JWTINSPECT exists for one job — decode jwts and lint for alg=none, weak secrets, and missing claims — and does it without a SaaS bill or heavyweight setup.
...
```bash
jwtinspect --version
jwtinspect scan .                      # scan the current project
jwtinspect scan . --format json
jwtinspect scan . --fail-on high       # non-zero exit for CI gates
jwtinspect mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **jwt_tool**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`jwtinspect` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
