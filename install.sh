#!/usr/bin/env sh
# Universal installer for jwtinspect. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/jwtinspect.git"
echo "Installing jwtinspect ..."
