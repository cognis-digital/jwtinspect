...
- **rules/analyzers** apply the heuristics shipped in `jwtinspect/core.py`.
- **score** ranks by severity.
- **MCP server** (`jwtinspect mcp`) exposes `scan` for Cognis.Studio agents.
