"""Native cognis-connect emit for jwtinspect — forward findings to any platform.

Maps jwtinspect's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    jwtinspect ... --format json | jwtinspect-emit --to stix
    jwtinspect-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
