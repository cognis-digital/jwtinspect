"""JWTINSPECT core — Decode JWTs and lint for alg=none, weak secrets, and missing claims."""
...
RULES = [
    ("JWT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("JWT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("JWT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
